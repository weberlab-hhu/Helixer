...
do
	...
	local_folder="$local_main_folder"h5_data_"$size"k_one_hot_5

	rm -r "$local_folder"/*

	../export.py --db-path-in $db_path --out-dir $local_folder --chunk-size "$size"000 --one-hot --genomes Athaliana,Bdistachyon,Creinhardtii,Gmax,Mguttatus,Mpolymorpha,Ptrichocarpa,Sitalica
